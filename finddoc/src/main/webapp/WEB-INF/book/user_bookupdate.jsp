...
<body>
	...
	<div class="container-fluid">
		<form role="form" class="form-horizontal" name="myform" method="get" action="/finddoc/user/bookupdate.do">
			<div class="form-group">
				<input type="text" class="booknum" name="booknum" value="${userbookinfo.booknum}">
				<input type="text" class="ykiho" name="ykiho" value="${userbookinfo.ykiho}">
				<label class="control-label col-sm-2" for="orgtel">병원명</label>
				<div class="col-sm-3">
					<input type="text" id="hosname" class="form-control" name="hname" value="${userbookinfo.hname}"
						placeholder="병원명" required disabled="disabled">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="text" id="datepicker" class="form-control" name="bookdate" value="${userbookinfo.bookdate}"
						placeholder="예약날짜">
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="text" id="name" name="name" placeholder="예약자" value="${userbookinfo.name}"
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="text" name="birthday" class="form-control"  value="${userbookinfo.birthday}"
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="text" id="text" name="text" placeholder="증상 또는 주의사항" value="${userbookinfo.text}"
						class="form-control">
				</div>
			</div>
			<br />
