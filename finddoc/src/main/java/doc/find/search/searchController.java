...
public class searchController {
	...
	public @ResponseBody String search_ajax(String loctxt, String hospname, String zipCd, String dgsbjtCd)
			throws IOException {
	...
	public @ResponseBody String search_pasing(String pageno, String loctxt, String hospname, String zipCd,
			String dgsbjtCd) throws IOException {
	...
	public @ResponseBody String dragmap_pasing(String pageno, String xPos, String yPos, String radius)
			throws IOException {
