...
public class MyUsernamePasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	protected String obtainUsername(HttpServletRequest request) {
		...
		System.out.println(emptype + "," + id);
		String combinedUsername = id + delimiter + emptype;
	...
	protected void unsuccessfulAuthentication(HttpServletRequest request, HttpServletResponse response,
		...
		request.getSession().removeAttribute("emptype");
		setAuthenticationFailureHandler(new SimpleUrlAuthenticationFailureHandler("/login/login?fail=true"));
